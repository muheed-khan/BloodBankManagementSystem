...
// $sql = "exec InsertDonnarData :fullname,:mobile,:email,:gender,:age, blodgroup,
// :address,:message ";
$dbh = new PDO( "sqlsrv:server=DESKTOP-76MODEJ ; Database = blood", "", "",array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'")); 
// $sql = "exec InsertDonnarData '$fullname','$mobile','$email','$gender','$age','$blodgroup',
// '$address','$message' ";

$sql = "exec InsertDonnarData '$fullname','$mobile','$email','$gender',$age,'$blodgroup', '$address','$message'"; 
...
<div class="col-sm-4">
<input type="text" name="mobileno" onKeyPress="return isNumberKey(event)"  maxlength="11" class="form-control" required>
</div>
</div>
